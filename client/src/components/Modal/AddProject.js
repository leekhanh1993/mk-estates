...
import { addPRO } from '../../actions/proActions'
...
class AddProject extends Component {
    ...
    handleClose() {
        this.props.setCloseAddProject(false)
    }
    ...
    render() {
        return (
            <Modal
                ...
                backdrop='static'
                show={this.props.showAddProject}
...
export default connect(mapStateToProps, { addPRO })(AddProject);