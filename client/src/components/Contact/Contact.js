...
class Contact extends Component {
    render() {
        ...
        <button type="submit" className="btn btn-default">Submit</button>
                ...
                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div className="map">
                        <iframe src="https://maps.google.com/maps?q=rmit%20university%20vietnam&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="650px" frameBorder={0} style={{border: 0}} allowFullScreen />
                    </div>
                </div>
            </div>
